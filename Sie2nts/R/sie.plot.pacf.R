...
#' @param se The option to indicate whether the 95% confidence interval is displayed or not, the default is FALSE
#'
...
sie.plot.pacf = function(ts, c, lag, type, ops = "2d", title = "", m=500, or =4, se = FALSE){
  # library(ggplot2)
  aux = list()
